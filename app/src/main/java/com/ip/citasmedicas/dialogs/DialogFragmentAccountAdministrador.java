...
public class DialogFragmentAccountAdministrador extends DialogFragment implements View.OnClickListener {
    ...
    private String uid="", user="", email="",ci="", telefono="", fotoPerfil ="";
    ...
    public DialogFragmentAccountAdministrador(){}
    ...
    private AlertDialog crearDialogoFrag(Bundle savedInstanceState) {
        ...
        v = inflater.inflate(R.layout.dialog_fragment_account_administrador, null);
        builder.setView(v);
        ...
        uid = getArguments().getString(Administrador.UID);
        user = getArguments().getString(Administrador.USERNAME);
        email = getArguments().getString(Administrador.EMAIL);
        ci = getArguments().getString(Administrador.CI);
        telefono = getArguments().getString(Administrador.TELEPHONE);
        fotoPerfil = getArguments().getString(Administrador.PHOTO_PERFIL);
        estado = getArguments().getBoolean(Administrador.ESTADO);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_FROM_GALLERY && resultCode == RESULT_OK){
            ...
            reference = storage.getReference().child(RutasRealtime.PATH_ADMINISTRADOR).child(email).
                    child("administrador");
